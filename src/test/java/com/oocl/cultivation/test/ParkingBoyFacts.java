...
class ParkingBoyFacts {
    ...
    @Test
    void parking_boy_should_output_error_message_when_given_no_ticket() {
        ParkingLot parkingLot = new ParkingLot();
        ParkingBoy utusan = new ParkingBoy(asList(parkingLot));
    ...
    @Test
    void parking_boy_should_output_error_message_if_parking_lot_exceed_capacity() {
        ParkingLot parkingLot = new ParkingLot();
        ParkingBoy utusan = new ParkingBoy(asList(parkingLot));
    ...
    @Test
    void smart_parking_boy_should_output_error_message_when_given_no_ticket() {
        ParkingLot parkingLot = new ParkingLot();
        SmartParkingBoy utusan = new SmartParkingBoy(asList(parkingLot));
    ...
    @Test
    void smart_parking_boy_should_output_error_message_if_parking_lot_exceed_capacity() {
        ParkingLot parkingLot = new ParkingLot();
        SmartParkingBoy utusan = new SmartParkingBoy(asList(parkingLot));
    ...
    @Test
    void smart_parking_boy_should_park_car_in_second_parking_lot_if_exceed_capacity_of_first() {
        ParkingLot parkingLot1 = new ParkingLot();
        ParkingLot parkingLot2 = new ParkingLot();
        SmartParkingBoy utusan = new SmartParkingBoy(asList(parkingLot1, parkingLot2));
